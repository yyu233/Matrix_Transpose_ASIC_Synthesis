set top_module matrix_transpose 
set rtlPath "./netlist"

# Target library
set target_library /home/linux/ieng6/ee260csp22/public/data/libraries/db/tcbn65gplustc.db
...
# read RTL
analyze -format verilog -lib WORK matrix_transpose.sv
